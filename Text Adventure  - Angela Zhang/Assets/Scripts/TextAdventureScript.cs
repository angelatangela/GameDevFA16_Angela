...
public class TextAdventureScript : MonoBehaviour {
	...
	void Update () {
		...
		case "Office Entrance":
			textBuffer = "RIP in the Office :'(\n"+"Angela Zhang\n";
			room_north = "Stairwell";


			break;
		case "Stairwell":
			textBuffer = "You're in the stairwell.\n Press the right arrow key to go to the next floor.";
		...
		case "Executive Office":
			...
			break;
		case "Secretary":
			textBuffer = "Hey, you don't have an appointment with the CEO.\n";
		...
		case "CEO Office":
			if(!hasGun){
			   ...
			   break;
		case "Kill CEO":
			textBuffer = "You found the CEO. Let's kill this man.\n"+
